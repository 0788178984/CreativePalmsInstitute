...
function isInstituteQuery(query) {
    const instituteKeywords = [
        "creative palms", "course", "program", "certificate", "diploma",
        "admission", "register", "enroll", "intake", "location", "contact",
        "fortportal", "requirements", "fees", "duration", "study"
    ];
...
async function callGeminiAPI(prompt) {
    ...
    if (identityKeywords.some(keyword => prompt.toLowerCase().includes(keyword))) {
        return "I'm Creative Palms Institute AI assistant. I was created by Lucky to help you!";
    }
...
window.addEventListener('load', () => {
    ...
    const welcomeMessage = `<div class="title-header">WELCOME TO CREATIVE PALMS INSTITUTE!</div>

I'm your AI Assistant, dedicated to helping you explore opportunities at Creative Palms Institute for Business and Vocational Studies.

<div class="title-header">OUR PROGRAMS:</div>

1. 📚 National Certificates (2 years)
2. 🎯 National Diplomas (2 years)
3. ⚡ Short Courses (1 month)
4. 🛠️ Vocational Programs (6 months)

<div class="title-header">WHAT CAN I HELP YOU WITH?</div>

1. 📋 Course details and requirements
2. 📝 Admission information
3. ✍️ Registration process
4. 📍 Institute location and contacts

<div class="title-header">HOW MAY I ASSIST YOU TODAY?</div>`;
